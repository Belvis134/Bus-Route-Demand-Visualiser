document.addEventListener('DOMContentLoaded', function() {
  ...
  Shiny.addCustomMessageHandler('fetch_datamall', function(params) {
    ...
    const csv_proxy_url = 'https://127.0.0.1/datamall-proxy' +
      '?date=' + datamall_date +
  ...
  Shiny.addCustomMessageHandler('fetch_drive_datamall', function(params) {
    ...
    var datamall_repository = `https://127.0.0.1/repository/datamall?datamall_date=${datamall_date}&data_type=${data_type}&data_type2=${data_type2}`;
   ...
   Shiny.addCustomMessageHandler('fetch_drive_busrouter', function(params) {
    ...
    const endpoint = `https://127.0.0.1/repository/busrouter?busrouter_date=${busrouter_date}&data_type=${data_type}`
    fetch(endpoint)
      .then(response => {
        if (!response.ok) {
          return response.text().then(text => {
