document.addEventListener('DOMContentLoaded', function() {
  ...
  Shiny.addCustomMessageHandler('fetch_datamall', function(params) {
    ...
    const csv_proxy_url = 'http://stcraft.myddns.me/datamall-proxy' +
      '?date=' + datamall_date +
  ...
  Shiny.addCustomMessageHandler('fetch_drive_datamall', function(params) {
    ...
    var datamall_repository = `http://stcraft.myddns.me/repository/datamall?datamall_date=${datamall_date}&data_type=${data_type}&data_type2=${data_type2}`;
   ...
   Shiny.addCustomMessageHandler('fetch_drive_busrouter', function(params) {
    ...
    const endpoint = `http://stcraft.myddns.me/repository/busrouter?busrouter_date=${busrouter_date}&data_type=${data_type}`
    fetch(endpoint)
      .then(response => {
        if (!response.ok) {
          return response.text().then(text => {
